print("Gustavo Moreira Pinto, Ciências da computação - RA: r839dg3")  

print("Lista1")

print("Exercicio 1: o algoritmo é um passo a passo que orienta o computador sobre o que fazer, É essencial no desenvolvimento de software, pois faz o programa funcionar de forma correta. ")
...
print("1")
print("O algoritmo começa pedindo que o usuário digite dois números. Em seguida, ele compara os dois valores. Se o primeiro número for maior que o segundo, o programa mostra que o primeiro é o maior. Caso contrário, mostra que o segundo é o maior. Por fim, o programa termina.")
...
print("2")
print(" Cálculo da fatura de energia elétrica")
...
def boletim_medidores(medidores):
    ...
    desv = sum(abs(c - media) for c in consumos)/len(consumos)    
